class Phoenix {
    constructor(game, x, y, speed) {
        ...
        this.walkRightAnim = new Animator(ASSET_MANAGER.getAsset(`./sprites/phoenixes/runRight.png`), 0, 0, 128, 128, 6, 0.5);
        this.walkLeftAnim = new Animator(ASSET_MANAGER.getAsset(`./sprites/phoenixes/runLeft.png`), 0, 0, 128, 128, 6, 0.5);
        this.attackRightAnim = new Animator(ASSET_MANAGER.getAsset(`./sprites/phoenixes/attackRight.png`), 0, 0, 128, 128, 14, 0.6);
        this.attackLeftAnim = new Animator(ASSET_MANAGER.getAsset(`./sprites/phoenixes/attackLeft.png`), 0, 0, 128, 128, 14, 0.6);
