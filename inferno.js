class inferno {
    constructor(game) {
        ...
        // Load animations
        this.idleRightAnim = new Animator(ASSET_MANAGER.getAsset(`./sprites/inferno/IdleRight.png`), 0, 0, 147, 64, 8, 0.5);
        this.idleLeftAnim = new Animator(ASSET_MANAGER.getAsset(`./sprites/inferno/IdleLeft.png`), 0, 0, 147, 64, 8, 0.5);
        this.walkRightAnim = new Animator(ASSET_MANAGER.getAsset(`./sprites/inferno/runRight.png`), 0, 5, 147, 64, 8, 0.5);
        this.walkLeftAnim = new Animator(ASSET_MANAGER.getAsset(`./sprites/inferno/runLeft.png`), 0, 5, 147, 64, 8, 0.5);
        this.attackRightAnim = new Animator(ASSET_MANAGER.getAsset(`./sprites/inferno/attackRight.png`), 0, 0, 147, 64, 8, 0.6);
        this.attackLeftAnim = new Animator(ASSET_MANAGER.getAsset(`./sprites/inferno/attackLeft.png`), 0, 0, 147, 64, 8, 0.6);
        ...
        this.spriteScale = 2;
        this.width = 147 * this.spriteScale;
    ...
    update() {
        ...
        const groundLevel = gameWorld.height - 120;  // Adjust this value based on your ground height
