class Shuriken {
    ...
    update() {
        ...
        this.game.entities.forEach(entity => {
            if (entity instanceof Eclipser || entity instanceof inferno || entity instanceof Drone || entity instanceof Phoenix || entity instanceof stormSpirit || entity instanceof Shizoku || entity instanceof LeviathDraconis) {
