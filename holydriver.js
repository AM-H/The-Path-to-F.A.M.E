class HolyDiver {
    constructor(game, aziel) {
        ...
        this.animationMap.set(`right`, new Animator(ASSET_MANAGER.getAsset(getAssetPath('sprites/HolyDiverRight.png')), 0, 0, 32, 32, 8, 0.1));
        this.animationMap.set(`left`, new Animator(ASSET_MANAGER.getAsset(getAssetPath('sprites/HolyDiverRight.png')), 0, 0, 32, 32, 8, 0.1));
