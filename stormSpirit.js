    ...
    constructor(game, x, speed) {
        ...
        class stormSpirit {
            ...
            update() {
                ...
                if (this.state === `attacking` && this.attackTimer > 0) {
                    ...
                    if (player.box && this.attackBox && this.attackBox.collide(player.box) && !this.hasDealtDamage) {
                        ...
                        if (this.debug) console.log(`Player hit by punch! Damage dealt: 1, Knockback applied: ${player.velocity.x}`);
                    }
            ...
            draw(ctx) {
                ...
                // Draw StormSpirit’s main animation
                if (this.state === `attacking`) {
                    ...
                    // Draw knockback effect inside attackBox only while attack is active and damage is dealt
            ...
            // [Other methods like updateBoundingBox, calculateJumpVelocity, etc., remain unchanged]
            updateBoundingBox() {
                const xOffset = (this.width - this.boxWidth) / 2;
